...
//extend UIImage class to load gif
extension UIImage {
    //MARK:- gif and image animation
   
    //load image from URL
    public class func gifImageWithURL(url:String) -> UIImage? {
        ...
        var image = gifImageWithData(imageData)
        if image == nil {
            image = UIImage.init(data: imageData)
        }
        return image
    }
    //load gif image from data
